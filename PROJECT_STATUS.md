...
1. **Define the unrealized P/L contract and currency/FX semantics before implementation**
   - Cost Basis v1 methodology, service-level implementation and public API contract are complete and validated.
