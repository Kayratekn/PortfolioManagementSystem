...
The next planned focused backend slice is **Portfolio Historical Performance + Benchmark Comparison discovery and contract definition**. It remains pending the two team/product decisions already identified: performance/cash-flow semantics and benchmark selection/data source. Do not invent resolutions for those decisions.
